    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="<%=dir%>admin/listarusuario.jsp"><h5>Listar Usuário</h5> <span class="sr-only">(current)</span></a>
                    </li>
        ...
        <div class="row">
            ...
            <div class="col-4">
                <form id="form-cadastro" action="<%=caminhoacao%>" method="POST">
                    ...
                    <div style="margin-top: 30%;" border="0" cellspacing="0" cellpadding="5" class="ajustar">
